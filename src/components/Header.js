...
import HeaderAdap from './HeaderAdap';
...
export default function Header() {
  ...
  return (
    <>
      <header className='h-[90px] w-full md:h-[135px] py-2 flex flex-col justify-center items-center lg:h-[90px] lg:flex-row justify-between bg-black px-3 fixed z-20 w-full'>
  ...
  return(
    <div onClick={handleClick} className='js-modal fixed z-50 top-0 left-0 w-full h-full bg-black opacity-90	flex justify-center items-center'>
      <div className='flex justify-center items-center'>
        <h1 className='text-slate-400 text-4xl font-bold'><input className='bg-black opacity-85 outline-none cursor-pointer' type="text" placeholder='Поиск...' /></h1>
