        ...
        <div className='flex flex-col gap-4 p-10'>
          ...
          <div>
            ...
            <select className='border p-2 w-full text-slate-400'>
              <option value="" key="1">--Любая--</option>
              <option value="" key="2">Покупка машины</option>
              <option value="" key="3">Профилактическое обслуживание</option>
              <option value="" key="4">Полный ремонт</option>
              <option value="" key="5">Тюнинг</option>
            </select>
          </div>
          <div>
            ...
            <select className='border p-2 w-full text-slate-400'>
              <option value="" key="1">--Любая--</option>
              <option value="" key="2">Ремонт и замена тормозов</option>
              <option value="" key="3">Ремонт топливной системы</option>
              <option value="" key="4">Мойка и детейлинг</option>
              <option value="" key="5">Ремонт электрики</option>
            </select>
          </div>
          <div>
            <p className='text-slate-400'>Адрес</p>
            <select className='border p-2 w-full text-slate-400'>
              <option value="" key="1">--Любой--</option>
              <option value="" key="2">Придорожная аллея, 7</option>
              <option value="" key="3">Учительская улица, 3</option>
            </select>
          </div>
